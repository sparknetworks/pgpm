CREATE OR REPLACE FUNCTION _pgpm._add_package_info(p_pkg_name varchar(255),
                                             ...
                                             p_pkg_old_rev integer DEFAULT NULL,
...
-- Case 3: moderate mode, adding old revision number
    ...
    WHERE pkg_name = p_pkg_name
        ...
        AND (pkg_old_rev IS NULL OR pkg_old_rev = p_pkg_old_rev);
